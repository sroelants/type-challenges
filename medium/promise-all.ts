...
type PromiseAllType<T extends readonly any[]> =
  ...
  ? First extends Promise<infer Inner>
  ? [Inner, ...PromiseAllType<Rest>]
  : [First, ...PromiseAllType<Rest>]
  : T;

declare function PromiseAll<T extends readonly any[]>(values: T): Promise<PromiseAllType<T>>
